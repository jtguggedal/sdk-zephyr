 ...
 *
 * @return 0 if successful, -ENOTSUP if not implemented,
 ...
 * @return true if connectivity is supported
 ...
 *
 *		 If data is written to the optval pointer, optlen will be set to the total number
 *		 of bytes written, regardless of whether an error is returned.
 *
 * @retval 0 if successful
 * @retval -ENOTSUP if net_if_set_opt is not implemented by the iface
 * @retval -ENOBUFS if retrieval buffer is too small
 * @retval -EINVAL if invalid retrieval buffer length is provided,
